...
export default function Footer() {
  return (
    <>
      <div className="w-full  flex items-center justify-center dark:bg-black pt-[3rem]">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
          ...
          <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            <p className="w-full md:w-2/3 text-gray-400 text-[2rem]">
          ...
          <div className="flex flex-col">
            <div className="flex mt-24 mb-12 flex-row justify-between">
              <div className=""></div>
              <Link className="hidden md:block cursor-pointer text-gray-600 hover:text-red-400 uppercase">
                About
              </Link>
              <Link className="hidden md:block cursor-pointer text-gray-600 hover:text-red-400 uppercase">
                Services
